...
const ImagesSection = () =>{
    ...
    const handleDelete = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>, imageUrl: string)=>{
        ...
        setValue("imageUrls", existingImageUrls.filter((url)=> url !== imageUrl));  //it keeps only those imageUrls in the database which do not the match the imageUrl of the image which we want to delete
    };
    ...
    return (
        <div>
            ...
            <div className="border rounded p-4 flex flex-col gap-4">
                ...
                <input type="file" 
                multiple
                accept="image/*"  //it specifies that it can only accept the files of type image
