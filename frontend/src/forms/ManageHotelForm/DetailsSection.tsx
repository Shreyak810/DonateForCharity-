...
const DetailsSection = () =>{
    ...
    return (
        <div className="flex flex-col gap-4">
            <h1 className="text-3xl font-bold mb-3">Add NGO</h1>
            ...
            <div className="flex gap-4">
                <label className="text-gray-700 text-sm font-bold flex-1">
                    ...
                    <input 
                    type="text"
                    className="border rounded w-full py-1 px-2 font-normal" {...register("city", {required: "This field is required"})}>
                    </input>
                    {errors.city && (
                ...
                <label className="text-gray-700 text-sm font-bold flex-1">
                    ...
                    <input 
                    type="text"
                    className="border rounded w-full py-1 px-2 font-normal" {...register("country", {required: "This field is required"})}>
                    </input>
                    {errors.country && (
